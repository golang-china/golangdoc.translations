...
// Package parser implements a parser for Go source files. Input may be provided
// in a variety of forms (see the various Parse* functions); the output is an
...
// corresponding ast.File node. The source code may be provided via the filename
// of the source file, or via the src parameter.
//
