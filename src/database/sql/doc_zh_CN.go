...
// NullBool代表了可空的bool类型。 NullBool实现了Scanner接口，所以它和NullString
// 一样可以被当做scan的目标变量。
...
// NullInt64代表了可空的int64类型。 NullInt64实现了Scanner接口，所以它和
// NullString一样可以被当做scan的目标变量。
...
// error occurs during the execution of the statement, that error will be
