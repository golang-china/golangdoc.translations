...
// even if a different codec is used. (In the future, these requirements may soften
// for custom codecs.)
//
...
// connection. Accept blocks; the caller typically invokes it in a go statement.
