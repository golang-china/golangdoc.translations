...
// ErrLength results from decoding an odd
// length slice.
...
// Decode decodes src into
// DecodedLen(len(src)) bytes, returning
...
// represented by the hexadecimal string s.
...
// Dump returns a string that contains a
// hex dump of the given data. The format
// of the hex dump matches the output of
...
// Dumper returns a WriteCloser that writes
// a hex dump of all written data to w. The
// format of the dump matches the output of
// `hexdump -C` on the command line.
...
// Encode encodes src into
// EncodedLen(len(src)) bytes of dst. As a
// convenience, it returns the number of
// bytes written to dst, but this value is
// always EncodedLen(len(src)). Encode
// implements hexadecimal encoding.
func Encode(dst, src []byte) int

// EncodeToString returns the hexadecimal encoding of src.

// EncodeToString returns the hexadecimal
// encoding of src.
func EncodeToString(src []byte) string

// EncodedLen returns the length of an encoding of n source bytes.

// EncodedLen returns the length of an
...
// InvalidByteError values describe errors
// resulting from an invalid byte in a hex
// string.
