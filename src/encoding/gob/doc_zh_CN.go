...
// are transmitted; that is, the values are flattened. Nil pointers are not
// permitted, as they have no value. Recursive types work fine, but recursive
// values (data with cycles) are problematic. This may change.
//
