...
// directly to the operating system, which then may, depending on the details of
// the call, reinterpret some of them as pointers. That is, the system call
...
// uintptr instead of unsafe.Pointer to keep callers from changing the result to
