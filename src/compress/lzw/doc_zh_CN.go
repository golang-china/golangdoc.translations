...
// lzw 包实现了 Lempel-Ziv-Welch 数据压缩格式, 这是一种 T. A. Welch 在 ``A
// Technique for High-Performance Data Compression'' 一文(Computer, 17(6) (June
// 1984), pp 8-19) 提出的一种压缩格式.
//
// 本包实现了用于 GIF/TIFF/PDF 文件的 lzw 压缩格式, 这是一种最长达到 12 位的变长
// 码, 头两个非字面码为 clear 和 EOF 码.
//
// TIFF 文件格式采用了类似但不兼容的 LZW 算法, 具体实现请参考
