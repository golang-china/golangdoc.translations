...
// Resetter 复位由 NewReader/NewReaderDict 返回的 ReadCloser, 底层以切换到新的 Reader.
// 允许重新使用 ReadCloser 而非分配一个新的.
...
// 效果上等价于将 w 设为使用 dst 和 w 的压缩水平, 字典重新调用 NewWriterLevel/NewWriterLevelDict 返回的 *Writer.
