...
// (-d.dddde±dd, a decimal exponent), 'E' (-d.ddddE±dd, a decimal exponent), 'f'
// (-ddd.dddd, no exponent), 'g' ('e' for large exponents, 'f' otherwise), or
...
// total number of digits. The special precision -1 uses the smallest number of
