...
// Package html provides functions for
// escaping and unescaping HTML text.
package html
...
// like "<" to become "&lt;". It escapes
// only five such characters: <, >, &, '
// and ". UnescapeString(EscapeString(s))
// == s always holds, but the converse
// isn't always true.
...
// UnescapeString unescapes entities like
// "&lt;" to become "<". It unescapes a
// larger range of entities than
// EscapeString escapes. For example,
// "&aacute;" unescapes to "á", as does
// "&#225;" and "&xE1;".
