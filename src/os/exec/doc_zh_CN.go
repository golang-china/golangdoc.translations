...
// named by the path environment variable. If file begins with "/", "#", "./",
// or "../", it is tried directly and the path is not consulted. The result may
// be an absolute path or a path relative to the current directory.
