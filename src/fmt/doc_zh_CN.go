...
// that for %g/%G it sets the total number of digits. For example, given 123.45
// the format %6.2f prints 123.45 while %.4g prints 123.5. The default precision
// for %e and %f is 6; for %g it is the smallest number of digits necessary to
