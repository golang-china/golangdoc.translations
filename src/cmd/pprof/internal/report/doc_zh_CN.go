...
// Package report summarizes a performance
// profile into a human-readable report.
package report
...
// Generate generates a report as directed
// by the Report.
...
// ScaleValue reformats a value from a unit
// to a different unit.
...
// Options are the formatting and filtering
// options used to generate a profile.
type Options struct {
	OutputFormat int
...
// Report contains the data and associated
// routines to extract a report from a
// profile.
type Report struct {
	// contains filtered or unexported fields
}

// New builds a new report indexing the sample values interpreting the samples with
// the provided function.

// New builds a new report indexing the
// sample values interpreting the samples
...
// NewDefault builds a new report indexing
// the sample values with the last value
// available.
