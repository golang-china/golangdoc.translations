...
// Package svg provides tools related to
...
// Massage enhances the SVG output from DOT
// to provide bettern panning inside a web
// browser. It uses the SVGPan library,
// which is accessed through the svgPan
// URL.
