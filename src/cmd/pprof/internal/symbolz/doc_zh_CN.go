...
// Package symbolz symbolizes a profile
// using the output from the symbolz
// service.
package symbolz
...
// Symbolize symbolizes profile p by
// parsing data returned by a symbolz
// handler. syms receives the symbolz query
// (hex addresses separated by '+') and
// returns the symbolz output in a string.
// It symbolizes all locations based on
// their addresses, regardless of mapping.
