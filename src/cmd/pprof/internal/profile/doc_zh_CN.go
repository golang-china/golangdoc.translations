...
func (*Profile) Aggregate(inlineFrame, function, filename, linenumber, address bool) error
...
func (*Profile) FilterSamplesByName(focus, ignore, hide *regexp.Regexp) (fm, im, hm bool)
...
func (*Profile) ParseMemoryMap(rd io.Reader) error
...
func (*Profile) Write(w io.Writer) error
