...
// A Reloc describes a relocation applied to a memory image to refer to an
// address within a particular symbol.
type Reloc struct {
...
// A Var describes a variable in a function stack frame: a declared local
// variable, an input argument, or an output result.
type Var struct {
...
// Parse parses an object file or archive from r, assuming that its import path
// is pkgpath.
