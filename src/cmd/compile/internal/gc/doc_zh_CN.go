...
func (*Fields) Set(s []*Field)

// Slice returns the entries in f as a slice.
// Changes to the slice entries will be reflected in f.
func (*Fields) Slice() []*Field

// Next returns the next field or method, if any.
func (*Iter) Next() *Field

func (*Mpflt) Add(b *Mpflt)

func (*Mpflt) AddFloat64(c float64)

func (*Mpflt) Cmp(b *Mpflt) int

func (*Mpflt) CmpFloat64(c float64) int

func (*Mpflt) Float32() float64

func (*Mpflt) Float64() float64

func (*Mpflt) Mul(b *Mpflt)

func (*Mpflt) MulFloat64(c float64)

func (*Mpflt) Neg()

func (*Mpflt) Quo(b *Mpflt)

func (*Mpflt) Set(b *Mpflt)

func (*Mpflt) SetFloat64(c float64)

func (*Mpflt) SetInt(b *Mpint)

// floating point input
// required syntax is [+-]d*[.]d*[e[+-]d*] or [+-]0xH*[e[+-]d*]
func (*Mpflt) SetString(as string)

func (*Mpflt) String() string

func (*Mpflt) Sub(b *Mpflt)

func (*Mpint) Add(b *Mpint)

func (*Mpint) And(b *Mpint)

func (*Mpint) AndNot(b *Mpint)

func (*Mpint) Cmp(b *Mpint) int

func (*Mpint) CmpInt64(c int64) int

func (*Mpint) Int64() int64

func (*Mpint) Lsh(b *Mpint)

func (*Mpint) Mul(b *Mpint)

func (*Mpint) Neg()

func (*Mpint) Or(b *Mpint)

func (*Mpint) Quo(b *Mpint)

func (*Mpint) Rem(b *Mpint)

func (*Mpint) Rsh(b *Mpint)

func (*Mpint) Set(b *Mpint)

func (*Mpint) SetFloat(b *Mpflt) int

func (*Mpint) SetInt64(c int64)

func (*Mpint) SetOverflow()

func (*Mpint) SetString(as string)

func (*Mpint) String() string

func (*Mpint) Sub(b *Mpint)

func (*Mpint) Xor(b *Mpint)
...
func (*Node) HasBreak() bool

// Int64 returns n as an int64.
// n must be an integer or rune constant.
func (*Node) Int64() int64
...
func (*Node) SetHasBreak(b bool)

// SetInt sets n's value to i.
// n must be an integer constant.
func (*Node) SetInt(i int64)

func (*Node) SetNotLiveAtEnd(b bool)
...
func (*Node) SetSliceBounds(low, high, max *Node)
...
// slice expression.
func (*Node) SliceBounds() (low, high, max *Node)

func (*Node) String() string

func (*Node) Typ() ssa.Type
...
func (*Nodes) Append(a ...*Node)

// AppendNodes appends the contents of *n2 to n, then clears n2.
func (*Nodes) AppendNodes(n2 *Nodes)

// MoveNodes sets n to the contents of n2, then clears n2.
func (*Nodes) MoveNodes(n2 *Nodes)

// Set sets n to a slice.
// This takes ownership of the slice.
func (*Nodes) Set(s []*Node)

// Set1 sets n to a slice containing a single node.
func (*Nodes) Set1(node *Node)
...
func (*SSAGenState) Pc() *obj.Prog

// SetLineno sets the current source line number.
func (*SSAGenState) SetLineno(l int32)

func (*Sym) String() string

func (*Type) Alignment() int64

func (*Type) AllMethods() *Fields

// ArgWidth returns the total aligned argument size for a function.
// It includes the receiver, parameters, and results.
func (*Type) ArgWidth() int64

// ChanArgs returns the channel type for TCHANARGS type t.
func (*Type) ChanArgs() *Type

// ChanDir returns the direction of a channel type t.
// The direction will be one of Crecv, Csend, or Cboth.
func (*Type) ChanDir() ChanDir

// ChanType returns t's extra channel-specific fields.
func (*Type) ChanType() *ChanType
...
func (*Type) Compare(u ssa.Type) ssa.Cmp

// Copy returns a shallow copy of the Type.
func (*Type) Copy() *Type

// DDDField returns the slice ... type for TDDDFIELD type t.
func (*Type) DDDField() *Type

// Elem returns the type of elements of t.
// Usable with pointers, channels, arrays, and slices.
func (*Type) Elem() *Type

func (*Type) ElemType() ssa.Type

// Field returns the i'th field/method of struct/interface type t.
func (*Type) Field(i int) *Field

func (*Type) FieldName(i int) string

func (*Type) FieldOff(i int) int64

// FieldSlice returns a slice of containing all fields/methods of
// struct/interface type t.
func (*Type) FieldSlice() []*Field

func (*Type) FieldType(i int) ssa.Type

func (*Type) Fields() *Fields

// ForwardType returns t's extra forward-type-specific fields.
func (*Type) ForwardType() *ForwardType

// FuncArgs returns the channel type for TFUNCARGS type t.
func (*Type) FuncArgs() *Type

// FuncType returns t's extra func-specific fields.
func (*Type) FuncType() *FuncType

// IncomparableField returns an incomparable Field of struct Type t, if any.
func (*Type) IncomparableField() *Field

func (*Type) IsArray() bool

func (*Type) IsBoolean() bool

func (*Type) IsChan() bool

// IsComparable reports whether t is a comparable type.
func (*Type) IsComparable() bool

func (*Type) IsComplex() bool

// IsEmptyInterface reports whether t is an empty interface type.
func (*Type) IsEmptyInterface() bool

func (*Type) IsFlags() bool

func (*Type) IsFloat() bool

// IsFuncArgStruct reports whether t is a struct representing function
// parameters.
func (*Type) IsFuncArgStruct() bool

func (*Type) IsInteger() bool

func (*Type) IsInterface() bool

// IsKind reports whether t is a Type of the specified kind.
func (*Type) IsKind(et EType) bool

func (*Type) IsMap() bool

func (*Type) IsMemory() bool

// IsPtr reports whether t is a regular Go pointer type.
// This does not include unsafe.Pointer.
func (*Type) IsPtr() bool
...
func (*Type) IsPtrShaped() bool

// IsRegularMemory reports whether t can be compared/hashed as regular memory.
func (*Type) IsRegularMemory() bool

func (*Type) IsSigned() bool

func (*Type) IsSlice() bool

func (*Type) IsString() bool

func (*Type) IsStruct() bool

// IsUnsafePtr reports whether t is an unsafe pointer.
func (*Type) IsUnsafePtr() bool

// IsUntyped reports whether t is an untyped type.
func (*Type) IsUntyped() bool

func (*Type) IsVoid() bool
...
func (*Type) Methods() *Fields

// Nname returns the associated function's nname.
func (*Type) Nname() *Node

func (*Type) NumElem() int64

func (*Type) NumFields() int

func (*Type) Params() *Type

func (*Type) ParamsP() **Type

func (*Type) PtrTo() ssa.Type

// Recv returns the receiver of function type t, if any.
func (*Type) Recv() *Field

func (*Type) Recvs() *Type

func (*Type) RecvsP() **Type

func (*Type) Results() *Type

func (*Type) ResultsP() **Type

// SetFields sets struct/interface type t's fields/methods to fields.
func (*Type) SetFields(fields []*Field)

// Nname sets the associated function's nname.
func (*Type) SetNname(n *Node)
...
func (*Type) SetNumElem(n int64)

func (*Type) SimpleString() string

func (*Type) Size() int64
...
func (ChanDir) CanRecv() bool

func (ChanDir) CanSend() bool

func (EType) String() string

// Addr returns the address of the i'th element of Nodes.
// It panics if n does not have at least i+1 elements.
func (Nodes) Addr(i int) **Node

// First returns the first element of Nodes (same as n.Index(0)).
// It panics if n has no elements.
func (Nodes) First() *Node

// Index returns the i'th element of Nodes.
// It panics if n does not have at least i+1 elements.
func (Nodes) Index(i int) *Node
...
func (Nodes) Second() *Node

// SetIndex sets the i'th element of Nodes to node.
// It panics if n does not have at least i+1 elements.
func (Nodes) SetIndex(i int, node *Node)

// Slice returns the entries in Nodes as a slice.
// Changes to the slice entries (as in s[i] = n) will be reflected in
// the Nodes.
func (Nodes) Slice() []*Node

func (Nodes) String() string

func (Op) GoString() string

// IsSlice3 reports whether o is a slice3 op (OSLICE3, OSLICE3ARR).
// o must be a slicing op.
func (Op) IsSlice3() bool
